...
const char *			CL_FILE_NAME = { "firstc.cl" };
...
main( int argc, char *argv[ ] ) {
	...
	fprintf( stdout, "%8d\t%4d\t%10d\tPerformance:%lf\n",
		NMB, LOCAL_SIZE, NUM_WORK_GROUPS, (double)(NUM_ELEMENTS+NUM_WORK_GROUPS)/(time1-time0)/1000000000. );
#ifdef WIN32
	Sleep( 2000 );
#endif
