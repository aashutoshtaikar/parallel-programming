...
if(iu==0||iu==NUMNODES-1)
{
        ...
        {
        //corner quarter nodes
        Xarea=fullTileArea/4;
        }
        else
        {
        //middle half nodes
        Xarea=fullTileArea/2;
        }
}
...
double ex=time1-time0;
printf("final volume:%f\n",volume);
printf("area:%f\n",area);
printf("Execution time:%lf\n",ex);
double megaMults = (double) (float)NUMNODES*(float)NUMNODES/(ex)/1000000.;
